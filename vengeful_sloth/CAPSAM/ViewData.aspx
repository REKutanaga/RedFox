<%@ Page Title="ViewData" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewData.aspx.cs" Inherits="CAPSAM.ViewData" EnableViewState="true" %>
        ...
        <asp:UpdatePanel ID="ViewDataUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="data-container">
                    ...
                    <div id="viewDataContainer" class="datacontainer-fade" style="display:block;" runat="server">
                    ...
                    <div id="addDataContainer" class="datacontainer-fade" style="display:none;" runat="server">
